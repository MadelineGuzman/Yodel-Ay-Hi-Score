...
gdjs.WinSceneCode.userFunc0x978270 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.WinSceneCode.userFunc0x978270(runtimeScene);
...
gdjs.WinSceneCode.asyncCallback15338636 = function (runtimeScene, asyncObjectsList) {
...
gdjs.WinSceneCode.idToCallbackMap.set(15338636, gdjs.WinSceneCode.asyncCallback15338636);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.WinSceneCode.asyncCallback15338636(runtimeScene, asyncObjectsList)), 15338636, asyncObjectsList);
}
}
